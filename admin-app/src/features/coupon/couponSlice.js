  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getACoupon.fulfilled, (state, action) => {
        ...
        state.couponDescription = action.payload?.description;
        state.couponLimit = action.payload?.limit;
        state.couponMinBill = action.payload?.minBillToApply;
        state.couponLimitTurn = action.payload?.limitTurn;
        state.couponActive = action.payload?.active;
      })
